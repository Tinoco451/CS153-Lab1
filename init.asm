...
main(void)
{
  ...
  a6:	e8 87 02 00 00       	call   332 <exit>
      exec("sh", argv);
  ab:	c7 44 24 04 d4 0a 00 	movl   $0xad4,0x4(%esp)
  b2:	00 
  b3:	c7 04 24 34 08 00 00 	movl   $0x834,(%esp)
  ba:	e8 ab 02 00 00       	call   36a <exec>
      printf(1, "init: exec sh failed\n");
  bf:	c7 44 24 04 37 08 00 	movl   $0x837,0x4(%esp)
  c6:	00 
  ...
  e7:	00 
  e8:	c7 04 24 06 08 00 00 	movl   $0x806,(%esp)
  ef:	e8 86 02 00 00       	call   37a <mknod>
    open("console", O_RDWR);
  f4:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  fb:	00 
  fc:	c7 04 24 06 08 00 00 	movl   $0x806,(%esp)
