...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 7c 72 10 80 	movl   $0x8010727c,(%esp)
...
80100409:	e8 b2 53 00 00       	call   801057c0 <uartputc>
...
801004b9:	e8 02 53 00 00       	call   801057c0 <uartputc>
801004be:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004c5:	e8 f6 52 00 00       	call   801057c0 <uartputc>
801004ca:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801004d1:	e8 ea 52 00 00       	call   801057c0 <uartputc>
...
80100b6c:	e8 af 5c 00 00       	call   80106820 <allocuvm>
...
80100b84:	e8 a7 5d 00 00       	call   80106930 <freevm>
  return -1;
...
80100bc8:	e8 93 5e 00 00       	call   80106a60 <clearpteu>
...
80100c31:	e8 8a 5f 00 00       	call   80106bc0 <copyout>
...
80100c9e:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100ca4:	e8 17 5f 00 00       	call   80106bc0 <copyout>
...
80100d1f:	e8 ac 58 00 00       	call   801065d0 <switchuvm>
  freevm(oldpgdir);
80100d24:	89 34 24             	mov    %esi,(%esp)
80100d27:	e8 04 5c 00 00       	call   80106930 <freevm>
  return 0;
...
80101eec:	e8 6f e4 ff ff       	call   80100360 <panic>
    panic("dirlink");
80101ef1:	c7 04 24 06 74 10 80 	movl   $0x80107406,(%esp)
...
80102da7:	e8 44 27 00 00       	call   801054f0 <idtinit>
...
80102dd3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102dd6:	e8 d5 37 00 00       	call   801065b0 <switchkvm>
  seginit();
80102ddb:	e8 10 37 00 00       	call   801064f0 <seginit>
  lapicinit();
...
80102e13:	e8 28 3c 00 00       	call   80106a40 <kvmalloc>
...
80102e25:	e8 c6 36 00 00       	call   801064f0 <seginit>
  picinit();       // disable pic
...
80102e3a:	e8 d1 29 00 00       	call   80105810 <uartinit>
80102e3f:	90                   	nop
  pinit();         // process table
80102e40:	e8 9b 07 00 00       	call   801035e0 <pinit>
  tvinit();        // trap vectors
80102e45:	e8 06 26 00 00       	call   80105450 <tvinit>
  binit();         // buffer cache
...
8010350e:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103511:	e8 7a 0d 00 00       	call   80104290 <release>
...
8010352d:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103530:	c7 40 14 37 54 10 80 	movl   $0x80105437,0x14(%eax)
...
8010354a:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010354d:	e8 8e 0d 00 00       	call   801042e0 <memset>
...
8010356f:	e8 1c 0d 00 00       	call   80104290 <release>
}
...
80103666:	c7 04 24 a8 72 10 80 	movl   $0x801072a8,(%esp)
...
801036e3:	e8 c8 32 00 00       	call   801069b0 <setupkvm>
...
80103705:	80 
80103706:	e8 d5 2f 00 00       	call   801066e0 <inituvm>
  p->sz = PGSIZE;
...
80103727:	e8 b4 0b 00 00       	call   801042e0 <memset>
...
80103782:	00 
80103783:	c7 44 24 04 e5 71 10 	movl   $0x801071e5,0x4(%esp)
8010378a:	80 
8010378b:	89 04 24             	mov    %eax,(%esp)
8010378e:	e8 2d 0d 00 00       	call   801044c0 <safestrcpy>
  p->cwd = namei("/");
80103793:	c7 04 24 ee 71 10 80 	movl   $0x801071ee,(%esp)
...
801037c7:	c7 04 24 cc 71 10 80 	movl   $0x801071cc,(%esp)
...
80103817:	e8 b4 2d 00 00       	call   801065d0 <switchuvm>
  return 0;
...
8010383a:	e8 d1 30 00 00       	call   80106910 <deallocuvm>
...
8010387e:	e8 0d 32 00 00       	call   80106a90 <copyuvm>
...
80103988:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
    acquire(&ptable.lock);
8010398d:	e8 8e 08 00 00       	call   80104220 <acquire>
...
801039b2:	83 c3 7c             	add    $0x7c,%ebx
      switchuvm(p);
801039b5:	e8 16 2c 00 00       	call   801065d0 <switchuvm>
...
801039cb:	e8 4b 0b 00 00       	call   8010451b <swtch>
      switchkvm();
801039d0:	e8 db 2b 00 00       	call   801065b0 <switchkvm>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
801039ef:	e8 9c 08 00 00       	call   80104290 <release>
  }
...
80103a14:	89 c3                	mov    %eax,%ebx
  if(!holding(&ptable.lock))
80103a16:	e8 c5 07 00 00       	call   801041e0 <holding>
...
80103a57:	e8 bf 0a 00 00       	call   8010451b <swtch>
  mycpu()->intena = intena;
...
80103a6e:	c7 04 24 f0 71 10 80 	movl   $0x801071f0,(%esp)
80103a75:	e8 e6 c8 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103a7a:	c7 04 24 1c 72 10 80 	movl   $0x8010721c,(%esp)
80103a81:	e8 da c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103a86:	c7 04 24 0e 72 10 80 	movl   $0x8010720e,(%esp)
80103a8d:	e8 ce c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103a92:	c7 04 24 02 72 10 80 	movl   $0x80107202,(%esp)
...
80103b03:	e8 18 07 00 00       	call   80104220 <acquire>
...
80103b96:	e8 65 fe ff ff       	call   80103a00 <sched>
  panic("zombie exit");
80103b9b:	c7 04 24 3d 72 10 80 	movl   $0x8010723d,(%esp)
80103ba2:	e8 b9 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103ba7:	c7 04 24 30 72 10 80 	movl   $0x80107230,(%esp)
...
80103bcd:	e8 4e 06 00 00       	call   80104220 <acquire>
...
80103bea:	e8 a1 06 00 00       	call   80104290 <release>
}
80103bef:	c9                   	leave  
80103bf0:	c3                   	ret    
...
80103c31:	e8 ea 05 00 00       	call   80104220 <acquire>
    release(lk);
80103c36:	89 34 24             	mov    %esi,(%esp)
80103c39:	e8 52 06 00 00       	call   80104290 <release>
  p->chan = chan;
...
80103c5b:	e8 30 06 00 00       	call   80104290 <release>
    acquire(lk);
...
80103c69:	5d                   	pop    %ebp
    acquire(lk);
80103c6a:	e9 b1 05 00 00       	jmp    80104220 <acquire>
80103c6f:	90                   	nop
  p->chan = chan;
...
80103c8e:	c7 04 24 4f 72 10 80 	movl   $0x8010724f,(%esp)
80103c95:	e8 c6 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103c9a:	c7 04 24 49 72 10 80 	movl   $0x80107249,(%esp)
...
80103cc4:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103cc6:	e8 55 05 00 00       	call   80104220 <acquire>
    havekids = 0;
...
80103d38:	e8 f3 2b 00 00       	call   80106930 <freevm>
        release(&ptable.lock);
...
80103d5d:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103d64:	e8 27 05 00 00       	call   80104290 <release>
}
...
80103d79:	e8 12 05 00 00       	call   80104290 <release>
}
...
80103da1:	e8 7a 04 00 00       	call   80104220 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
...
80103de3:	5d                   	pop    %ebp
  release(&ptable.lock);
80103de4:	e9 a7 04 00 00       	jmp    80104290 <release>
...
80103e01:	e8 1a 04 00 00       	call   80104220 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103e33:	e8 58 04 00 00       	call   80104290 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80103e57:	e8 34 04 00 00       	call   80104290 <release>
}
...
80103e84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e88:	c7 04 24 7c 72 10 80 	movl   $0x8010727c,(%esp)
...
80103eaa:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103ead:	ba 60 72 10 80       	mov    $0x80107260,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103eb2:	77 11                	ja     80103ec5 <procdump+0x55>
80103eb4:	8b 14 85 f4 72 10 80 	mov    -0x7fef8d0c(,%eax,4),%edx
      state = "???";
80103ebb:	b8 60 72 10 80       	mov    $0x80107260,%eax
...
80103ed0:	c7 04 24 64 72 10 80 	movl   $0x80107264,(%esp)
...
80103efc:	e8 cf 01 00 00       	call   801040d0 <getcallerpcs>
...
80103f19:	c7 04 24 a1 6c 10 80 	movl   $0x80106ca1,(%esp)
...
80103f46:	c7 04 24 d0 72 10 80 	movl   $0x801072d0,(%esp)
80103f4d:	e8 fe c6 ff ff       	call   80100650 <cprintf>
}
80103f52:	c9                   	leave  
80103f53:	c3                   	ret    
...
80103f63:	83 ec 18             	sub    $0x18,%esp
  cprintf("\n\n placeholder\n\n");
80103f66:	c7 04 24 6d 72 10 80 	movl   $0x8010726d,(%esp)
80103f6d:	e8 de c6 ff ff       	call   80100650 <cprintf>
}
80103f72:	c9                   	leave  
80103f73:	c3                   	ret    
80103f74:	66 90                	xchg   %ax,%ax
80103f76:	66 90                	xchg   %ax,%ax
...
80103f8a:	c7 44 24 04 0c 73 10 	movl   $0x8010730c,0x4(%esp)
80103f91:	80 
...
80103fe7:	e8 14 fc ff ff       	call   80103c00 <sleep>
  while (lk->locked) {
...
80104046:	e8 45 fd ff ff       	call   80103d90 <wakeup>
  release(&lk->lk);
...
801041b9:	c3                   	ret    
    panic("popcli");
801041ba:	c7 04 24 2e 73 10 80 	movl   $0x8010732e,(%esp)
801041c1:	e8 9a c1 ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
801041c6:	c7 04 24 17 73 10 80 	movl   $0x80107317,(%esp)
...
80104274:	c3                   	ret    
    panic("acquire");
80104275:	c7 04 24 35 73 10 80 	movl   $0x80107335,(%esp)
...
801042c2:	e9 a9 fe ff ff       	jmp    80104170 <popcli>
    panic("release");
801042c7:	c7 04 24 3d 73 10 80 	movl   $0x8010733d,(%esp)
...
801046bd:	8b 14 85 80 73 10 80 	mov    -0x7fef8c80(,%eax,4),%edx
...
801046e6:	c7 04 24 45 73 10 80 	movl   $0x80107345,(%esp)
...
80104870:	c7 44 24 04 fc 73 10 	movl   $0x801073fc,0x4(%esp)
80104877:	80 
...
8010488b:	c7 44 24 04 fb 73 10 	movl   $0x801073fb,0x4(%esp)
80104892:	80 
...
801048a1:	79 89                	jns    8010482c <create+0xdc>
      panic("create dots");
801048a3:	c7 04 24 ef 73 10 80 	movl   $0x801073ef,(%esp)
801048aa:	e8 b1 ba ff ff       	call   80100360 <panic>
    panic("create: dirlink");
801048af:	c7 04 24 fe 73 10 80 	movl   $0x801073fe,(%esp)
801048b6:	e8 a5 ba ff ff       	call   80100360 <panic>
    panic("create: ialloc");
801048bb:	c7 04 24 e0 73 10 80 	movl   $0x801073e0,(%esp)
...
80104c61:	c7 44 24 04 fc 73 10 	movl   $0x801073fc,0x4(%esp)
80104c68:	80 
...
80104c79:	c7 44 24 04 fb 73 10 	movl   $0x801073fb,0x4(%esp)
80104c80:	80 
...
80104dcd:	c7 04 24 20 74 10 80 	movl   $0x80107420,(%esp)
80104dd4:	e8 87 b5 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104dd9:	c7 04 24 32 74 10 80 	movl   $0x80107432,(%esp)
80104de0:	e8 7b b5 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104de5:	c7 04 24 0e 74 10 80 	movl   $0x8010740e,(%esp)
...
80105253:	5d                   	pop    %ebp
  return fork();
80105254:	e9 f7 e5 ff ff       	jmp    80103850 <fork>
...
80105263:	83 ec 08             	sub    $0x8,%esp
  exit();
80105266:	e8 35 e8 ff ff       	call   80103aa0 <exit>
...
80105273:	5d                   	pop    %ebp
  return wait();
80105274:	e9 37 ea ff ff       	jmp    80103cb0 <wait>
...
80105294:	e8 37 f3 ff ff       	call   801045d0 <argint>
...
801052a3:	e8 48 eb ff ff       	call   80103df0 <kill>
}
801052a8:	c9                   	leave  
801052a9:	c3                   	ret    
...
801052c3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801052c6:	e8 d5 e3 ff ff       	call   801036a0 <myproc>
...
801052e5:	e8 e6 f2 ff ff       	call   801045d0 <argint>
801052ea:	85 c0                	test   %eax,%eax
801052ec:	78 22                	js     80105310 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801052ee:	e8 ad e3 ff ff       	call   801036a0 <myproc>
  if(growproc(n) < 0)
...
801052fb:	e8 e0 e4 ff ff       	call   801037e0 <growproc>
...
80105335:	e8 96 f2 ff ff       	call   801045d0 <argint>
8010533a:	85 c0                	test   %eax,%eax
8010533c:	78 7e                	js     801053bc <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
8010533e:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
80105345:	e8 d6 ee ff ff       	call   80104220 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010534a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010534d:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  while(ticks - ticks0 < n){
...
80105360:	c7 44 24 04 60 4c 11 	movl   $0x80114c60,0x4(%esp)
80105367:	80 
80105368:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
8010536f:	e8 8c e8 ff ff       	call   80103c00 <sleep>
  while(ticks - ticks0 < n){
80105374:	a1 a0 54 11 80       	mov    0x801154a0,%eax
80105379:	29 d8                	sub    %ebx,%eax
8010537b:	3b 45 f4             	cmp    -0xc(%ebp),%eax
8010537e:	73 28                	jae    801053a8 <sys_sleep+0x88>
    if(myproc()->killed){
80105380:	e8 1b e3 ff ff       	call   801036a0 <myproc>
80105385:	8b 40 24             	mov    0x24(%eax),%eax
80105388:	85 c0                	test   %eax,%eax
8010538a:	74 d4                	je     80105360 <sys_sleep+0x40>
      release(&tickslock);
8010538c:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
80105393:	e8 f8 ee ff ff       	call   80104290 <release>
      return -1;
...
801053a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&tickslock);
801053a8:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
801053af:	e8 dc ee ff ff       	call   80104290 <release>
}
...
801053d4:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
801053d7:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
801053de:	e8 3d ee ff ff       	call   80104220 <acquire>
  xticks = ticks;
801053e3:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  release(&tickslock);
801053e9:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
801053f0:	e8 9b ee ff ff       	call   80104290 <release>
  return xticks;
}
...
80105403:	83 ec 08             	sub    $0x8,%esp
  hello();
80105406:	e8 35 eb ff ff       	call   80103f40 <hello>
  return 0;
}
...
80105413:	83 ec 08             	sub    $0x8,%esp
  getparents();
80105416:	e8 45 eb ff ff       	call   80103f60 <getparents>
  return 0;
...
80105420:	06                   	push   %es
  pushl %fs
80105421:	0f a0                	push   %fs
  pushl %gs
80105423:	0f a8                	push   %gs
  pushal
80105425:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105426:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010542a:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010542c:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
8010542e:	54                   	push   %esp
  call trap
8010542f:	e8 ec 00 00 00       	call   80105520 <trap>
  addl $4, %esp
80105434:	83 c4 04             	add    $0x4,%esp
...
80105437:	61                   	popa   
  popl %gs
80105438:	0f a9                	pop    %gs
  popl %fs
8010543a:	0f a1                	pop    %fs
  popl %es
8010543c:	07                   	pop    %es
  popl %ds
8010543d:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
8010543e:	83 c4 08             	add    $0x8,%esp
  iret
80105441:	cf                   	iret   
80105442:	66 90                	xchg   %ax,%ax
...
80105464:	66 89 0c c5 a2 4c 11 	mov    %cx,-0x7feeb35e(,%eax,8)
8010546b:	80 
8010546c:	c6 04 c5 a4 4c 11 80 	movb   $0x0,-0x7feeb35c(,%eax,8)
80105473:	00 
80105474:	c6 04 c5 a5 4c 11 80 	movb   $0x8e,-0x7feeb35b(,%eax,8)
8010547b:	8e 
8010547c:	66 89 14 c5 a0 4c 11 	mov    %dx,-0x7feeb360(,%eax,8)
80105483:	80 
80105484:	c1 ea 10             	shr    $0x10,%edx
80105487:	66 89 14 c5 a6 4c 11 	mov    %dx,-0x7feeb35a(,%eax,8)
8010548e:	80 
  for(i = 0; i < 256; i++)
...
801054a9:	c7 44 24 04 41 74 10 	movl   $0x80107441,0x4(%esp)
801054b0:	80 
801054b1:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801054b8:	66 89 15 a2 4e 11 80 	mov    %dx,0x80114ea2
801054bf:	66 a3 a0 4e 11 80    	mov    %ax,0x80114ea0
801054c5:	c1 e8 10             	shr    $0x10,%eax
801054c8:	c6 05 a4 4e 11 80 00 	movb   $0x0,0x80114ea4
801054cf:	c6 05 a5 4e 11 80 ef 	movb   $0xef,0x80114ea5
801054d6:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  initlock(&tickslock, "time");
801054dc:	e8 cf eb ff ff       	call   801040b0 <initlock>
}
801054e1:	c9                   	leave  
801054e2:	c3                   	ret    
...
801054fb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801054ff:	b8 a0 4c 11 80       	mov    $0x80114ca0,%eax
...
80105532:	0f 84 a0 01 00 00    	je     801056d8 <trap+0x1b8>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80105538:	83 e8 20             	sub    $0x20,%eax
8010553b:	83 f8 1f             	cmp    $0x1f,%eax
8010553e:	77 08                	ja     80105548 <trap+0x28>
80105540:	ff 24 85 e8 74 10 80 	jmp    *-0x7fef8b18(,%eax,4)
80105547:	90                   	nop
    lapiceoi();
    break;
...
80105548:	e8 53 e1 ff ff       	call   801036a0 <myproc>
8010554d:	85 c0                	test   %eax,%eax
8010554f:	90                   	nop
80105550:	0f 84 fa 01 00 00    	je     80105750 <trap+0x230>
80105556:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010555a:	0f 84 f0 01 00 00    	je     80105750 <trap+0x230>
...
8010556c:	e8 0f e1 ff ff       	call   80103680 <cpuid>
...
8010557c:	e8 1f e1 ff ff       	call   801036a0 <myproc>
80105581:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105584:	e8 17 e1 ff ff       	call   801036a0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105589:	8b 55 dc             	mov    -0x24(%ebp),%edx
8010558c:	89 74 24 0c          	mov    %esi,0xc(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
80105590:	8b 75 e0             	mov    -0x20(%ebp),%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105593:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105596:	89 7c 24 14          	mov    %edi,0x14(%esp)
8010559a:	89 54 24 18          	mov    %edx,0x18(%esp)
8010559e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
            myproc()->pid, myproc()->name, tf->trapno,
801055a1:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801055a4:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
801055a8:	89 74 24 08          	mov    %esi,0x8(%esp)
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801055ac:	89 54 24 10          	mov    %edx,0x10(%esp)
801055b0:	8b 40 10             	mov    0x10(%eax),%eax
801055b3:	c7 04 24 a4 74 10 80 	movl   $0x801074a4,(%esp)
...
801055d9:	e8 c2 e0 ff ff       	call   801036a0 <myproc>
...
801055e5:	e8 b6 e0 ff ff       	call   801036a0 <myproc>
...
801055f9:	74 4d                	je     80105648 <trap+0x128>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801055fb:	e8 a0 e0 ff ff       	call   801036a0 <myproc>
80105600:	85 c0                	test   %eax,%eax
80105602:	74 1d                	je     80105621 <trap+0x101>
80105604:	e8 97 e0 ff ff       	call   801036a0 <myproc>
...
8010561b:	0f 84 e8 00 00 00    	je     80105709 <trap+0x1e9>
    exit();
}
...
8010563b:	75 a8                	jne    801055e5 <trap+0xc5>
    exit();
8010563d:	e8 5e e4 ff ff       	call   80103aa0 <exit>
...
80105650:	75 a9                	jne    801055fb <trap+0xdb>
    yield();
80105652:	e8 69 e5 ff ff       	call   80103bc0 <yield>
80105657:	eb a2                	jmp    801055fb <trap+0xdb>
80105659:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105660:	e8 1b e0 ff ff       	call   80103680 <cpuid>
80105665:	85 c0                	test   %eax,%eax
80105667:	0f 84 b3 00 00 00    	je     80105720 <trap+0x200>
8010566d:	8d 76 00             	lea    0x0(%esi),%esi
    lapiceoi();
80105670:	e8 0b d1 ff ff       	call   80102780 <lapiceoi>
    break;
80105675:	e9 56 ff ff ff       	jmp    801055d0 <trap+0xb0>
8010567a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    kbdintr();
80105680:	e8 4b cf ff ff       	call   801025d0 <kbdintr>
    lapiceoi();
80105685:	e8 f6 d0 ff ff       	call   80102780 <lapiceoi>
    break;
8010568a:	e9 41 ff ff ff       	jmp    801055d0 <trap+0xb0>
8010568f:	90                   	nop
    uartintr();
80105690:	e8 1b 02 00 00       	call   801058b0 <uartintr>
    lapiceoi();
80105695:	e8 e6 d0 ff ff       	call   80102780 <lapiceoi>
    break;
8010569a:	e9 31 ff ff ff       	jmp    801055d0 <trap+0xb0>
8010569f:	90                   	nop
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801056a0:	8b 7b 38             	mov    0x38(%ebx),%edi
801056a3:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
801056a7:	e8 d4 df ff ff       	call   80103680 <cpuid>
801056ac:	c7 04 24 4c 74 10 80 	movl   $0x8010744c,(%esp)
...
801056bf:	e8 8c af ff ff       	call   80100650 <cprintf>
    lapiceoi();
801056c4:	e8 b7 d0 ff ff       	call   80102780 <lapiceoi>
    break;
801056c9:	e9 02 ff ff ff       	jmp    801055d0 <trap+0xb0>
801056ce:	66 90                	xchg   %ax,%ax
    ideintr();
801056d0:	e8 ab c9 ff ff       	call   80102080 <ideintr>
801056d5:	eb 96                	jmp    8010566d <trap+0x14d>
801056d7:	90                   	nop
801056d8:	90                   	nop
801056d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
801056e0:	e8 bb df ff ff       	call   801036a0 <myproc>
801056e5:	8b 70 24             	mov    0x24(%eax),%esi
801056e8:	85 f6                	test   %esi,%esi
801056ea:	75 2c                	jne    80105718 <trap+0x1f8>
    myproc()->tf = tf;
801056ec:	e8 af df ff ff       	call   801036a0 <myproc>
801056f1:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801056f4:	e8 a7 ef ff ff       	call   801046a0 <syscall>
    if(myproc()->killed)
801056f9:	e8 a2 df ff ff       	call   801036a0 <myproc>
801056fe:	8b 48 24             	mov    0x24(%eax),%ecx
80105701:	85 c9                	test   %ecx,%ecx
80105703:	0f 84 18 ff ff ff    	je     80105621 <trap+0x101>
}
80105709:	83 c4 3c             	add    $0x3c,%esp
8010570c:	5b                   	pop    %ebx
8010570d:	5e                   	pop    %esi
8010570e:	5f                   	pop    %edi
8010570f:	5d                   	pop    %ebp
      exit();
80105710:	e9 8b e3 ff ff       	jmp    80103aa0 <exit>
80105715:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
80105718:	e8 83 e3 ff ff       	call   80103aa0 <exit>
8010571d:	eb cd                	jmp    801056ec <trap+0x1cc>
8010571f:	90                   	nop
      acquire(&tickslock);
80105720:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
80105727:	e8 f4 ea ff ff       	call   80104220 <acquire>
      wakeup(&ticks);
8010572c:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
      ticks++;
80105733:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
8010573a:	e8 51 e6 ff ff       	call   80103d90 <wakeup>
      release(&tickslock);
8010573f:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
80105746:	e8 45 eb ff ff       	call   80104290 <release>
8010574b:	e9 1d ff ff ff       	jmp    8010566d <trap+0x14d>
80105750:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105753:	8b 73 38             	mov    0x38(%ebx),%esi
80105756:	e8 25 df ff ff       	call   80103680 <cpuid>
8010575b:	89 7c 24 10          	mov    %edi,0x10(%esp)
8010575f:	89 74 24 0c          	mov    %esi,0xc(%esp)
80105763:	89 44 24 08          	mov    %eax,0x8(%esp)
80105767:	8b 43 30             	mov    0x30(%ebx),%eax
8010576a:	c7 04 24 70 74 10 80 	movl   $0x80107470,(%esp)
80105771:	89 44 24 04          	mov    %eax,0x4(%esp)
80105775:	e8 d6 ae ff ff       	call   80100650 <cprintf>
      panic("trap");
8010577a:	c7 04 24 46 74 10 80 	movl   $0x80107446,(%esp)
80105781:	e8 da ab ff ff       	call   80100360 <panic>
...
8010579a:	74 14                	je     801057b0 <uartgetc+0x20>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010579c:	ba fd 03 00 00       	mov    $0x3fd,%edx
801057a1:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
801057a2:	a8 01                	test   $0x1,%al
801057a4:	74 0a                	je     801057b0 <uartgetc+0x20>
801057a6:	b2 f8                	mov    $0xf8,%dl
801057a8:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
801057a9:	0f b6 c0             	movzbl %al,%eax
}
801057ac:	5d                   	pop    %ebp
801057ad:	c3                   	ret    
...
801057c7:	74 3f                	je     80105808 <uartputc+0x48>
{
801057c9:	55                   	push   %ebp
801057ca:	89 e5                	mov    %esp,%ebp
801057cc:	56                   	push   %esi
801057cd:	be fd 03 00 00       	mov    $0x3fd,%esi
801057d2:	53                   	push   %ebx
  if(!uart)
801057d3:	bb 80 00 00 00       	mov    $0x80,%ebx
{
801057d8:	83 ec 10             	sub    $0x10,%esp
801057db:	eb 14                	jmp    801057f1 <uartputc+0x31>
801057dd:	8d 76 00             	lea    0x0(%esi),%esi
    microdelay(10);
801057e0:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
801057e7:	e8 b4 cf ff ff       	call   801027a0 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801057ec:	83 eb 01             	sub    $0x1,%ebx
801057ef:	74 07                	je     801057f8 <uartputc+0x38>
801057f1:	89 f2                	mov    %esi,%edx
801057f3:	ec                   	in     (%dx),%al
801057f4:	a8 20                	test   $0x20,%al
801057f6:	74 e8                	je     801057e0 <uartputc+0x20>
  outb(COM1+0, c);
801057f8:	0f b6 45 08          	movzbl 0x8(%ebp),%eax
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801057fc:	ba f8 03 00 00       	mov    $0x3f8,%edx
...
80105806:	5e                   	pop    %esi
80105807:	5d                   	pop    %ebp
80105808:	f3 c3                	repz ret 
8010580a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80105810 <uartinit>:
{
80105810:	55                   	push   %ebp
80105811:	31 c9                	xor    %ecx,%ecx
80105813:	89 e5                	mov    %esp,%ebp
80105815:	89 c8                	mov    %ecx,%eax
80105817:	57                   	push   %edi
80105818:	bf fa 03 00 00       	mov    $0x3fa,%edi
8010581d:	56                   	push   %esi
8010581e:	89 fa                	mov    %edi,%edx
80105820:	53                   	push   %ebx
80105821:	83 ec 1c             	sub    $0x1c,%esp
80105824:	ee                   	out    %al,(%dx)
80105825:	be fb 03 00 00       	mov    $0x3fb,%esi
8010582a:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
8010582f:	89 f2                	mov    %esi,%edx
80105831:	ee                   	out    %al,(%dx)
80105832:	b8 0c 00 00 00       	mov    $0xc,%eax
80105837:	b2 f8                	mov    $0xf8,%dl
80105839:	ee                   	out    %al,(%dx)
8010583a:	bb f9 03 00 00       	mov    $0x3f9,%ebx
8010583f:	89 c8                	mov    %ecx,%eax
80105841:	89 da                	mov    %ebx,%edx
80105843:	ee                   	out    %al,(%dx)
80105844:	b8 03 00 00 00       	mov    $0x3,%eax
80105849:	89 f2                	mov    %esi,%edx
8010584b:	ee                   	out    %al,(%dx)
8010584c:	b2 fc                	mov    $0xfc,%dl
8010584e:	89 c8                	mov    %ecx,%eax
80105850:	ee                   	out    %al,(%dx)
80105851:	b8 01 00 00 00       	mov    $0x1,%eax
80105856:	89 da                	mov    %ebx,%edx
80105858:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105859:	b2 fd                	mov    $0xfd,%dl
8010585b:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
8010585c:	3c ff                	cmp    $0xff,%al
8010585e:	74 42                	je     801058a2 <uartinit+0x92>
  uart = 1;
80105860:	c7 05 bc a5 10 80 01 	movl   $0x1,0x8010a5bc
80105867:	00 00 00 
8010586a:	89 fa                	mov    %edi,%edx
8010586c:	ec                   	in     (%dx),%al
8010586d:	b2 f8                	mov    $0xf8,%dl
8010586f:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80105870:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105877:	00 
  for(p="xv6...\n"; *p; p++)
80105878:	bb 68 75 10 80       	mov    $0x80107568,%ebx
  ioapicenable(IRQ_COM1, 0);
8010587d:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80105884:	e8 27 ca ff ff       	call   801022b0 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
80105889:	b8 78 00 00 00       	mov    $0x78,%eax
8010588e:	66 90                	xchg   %ax,%ax
    uartputc(*p);
80105890:	89 04 24             	mov    %eax,(%esp)
  for(p="xv6...\n"; *p; p++)
80105893:	83 c3 01             	add    $0x1,%ebx
    uartputc(*p);
80105896:	e8 25 ff ff ff       	call   801057c0 <uartputc>
  for(p="xv6...\n"; *p; p++)
8010589b:	0f be 03             	movsbl (%ebx),%eax
8010589e:	84 c0                	test   %al,%al
801058a0:	75 ee                	jne    80105890 <uartinit+0x80>
}
801058a2:	83 c4 1c             	add    $0x1c,%esp
801058a5:	5b                   	pop    %ebx
801058a6:	5e                   	pop    %esi
801058a7:	5f                   	pop    %edi
801058a8:	5d                   	pop    %ebp
...
801058b6:	c7 04 24 90 57 10 80 	movl   $0x80105790,(%esp)
801058bd:	e8 ee ae ff ff       	call   801007b0 <consoleintr>
}
801058c2:	c9                   	leave  
801058c3:	c3                   	ret    
...
801058c6:	6a 00                	push   $0x0
  jmp alltraps
801058c8:	e9 52 fb ff ff       	jmp    8010541f <alltraps>
...
801058cf:	6a 01                	push   $0x1
  jmp alltraps
801058d1:	e9 49 fb ff ff       	jmp    8010541f <alltraps>
...
801058d8:	6a 02                	push   $0x2
  jmp alltraps
801058da:	e9 40 fb ff ff       	jmp    8010541f <alltraps>
...
801058e1:	6a 03                	push   $0x3
  jmp alltraps
801058e3:	e9 37 fb ff ff       	jmp    8010541f <alltraps>
...
801058ea:	6a 04                	push   $0x4
  jmp alltraps
801058ec:	e9 2e fb ff ff       	jmp    8010541f <alltraps>
...
801058f3:	6a 05                	push   $0x5
  jmp alltraps
801058f5:	e9 25 fb ff ff       	jmp    8010541f <alltraps>
...
801058fc:	6a 06                	push   $0x6
  jmp alltraps
801058fe:	e9 1c fb ff ff       	jmp    8010541f <alltraps>
...
80105905:	6a 07                	push   $0x7
  jmp alltraps
80105907:	e9 13 fb ff ff       	jmp    8010541f <alltraps>
...
8010590c:	6a 08                	push   $0x8
  jmp alltraps
8010590e:	e9 0c fb ff ff       	jmp    8010541f <alltraps>
...
80105915:	6a 09                	push   $0x9
  jmp alltraps
80105917:	e9 03 fb ff ff       	jmp    8010541f <alltraps>
...
8010591c:	6a 0a                	push   $0xa
  jmp alltraps
8010591e:	e9 fc fa ff ff       	jmp    8010541f <alltraps>
...
80105923:	6a 0b                	push   $0xb
  jmp alltraps
80105925:	e9 f5 fa ff ff       	jmp    8010541f <alltraps>
...
8010592a:	6a 0c                	push   $0xc
  jmp alltraps
8010592c:	e9 ee fa ff ff       	jmp    8010541f <alltraps>
...
80105931:	6a 0d                	push   $0xd
  jmp alltraps
80105933:	e9 e7 fa ff ff       	jmp    8010541f <alltraps>
...
80105938:	6a 0e                	push   $0xe
  jmp alltraps
8010593a:	e9 e0 fa ff ff       	jmp    8010541f <alltraps>
...
80105941:	6a 0f                	push   $0xf
  jmp alltraps
80105943:	e9 d7 fa ff ff       	jmp    8010541f <alltraps>
...
8010594a:	6a 10                	push   $0x10
  jmp alltraps
8010594c:	e9 ce fa ff ff       	jmp    8010541f <alltraps>
...
80105951:	6a 11                	push   $0x11
  jmp alltraps
80105953:	e9 c7 fa ff ff       	jmp    8010541f <alltraps>
...
8010595a:	6a 12                	push   $0x12
  jmp alltraps
8010595c:	e9 be fa ff ff       	jmp    8010541f <alltraps>
...
80105963:	6a 13                	push   $0x13
  jmp alltraps
80105965:	e9 b5 fa ff ff       	jmp    8010541f <alltraps>
...
8010596c:	6a 14                	push   $0x14
  jmp alltraps
8010596e:	e9 ac fa ff ff       	jmp    8010541f <alltraps>
...
80105975:	6a 15                	push   $0x15
  jmp alltraps
80105977:	e9 a3 fa ff ff       	jmp    8010541f <alltraps>
...
8010597e:	6a 16                	push   $0x16
  jmp alltraps
80105980:	e9 9a fa ff ff       	jmp    8010541f <alltraps>
...
80105987:	6a 17                	push   $0x17
  jmp alltraps
80105989:	e9 91 fa ff ff       	jmp    8010541f <alltraps>
...
80105990:	6a 18                	push   $0x18
  jmp alltraps
80105992:	e9 88 fa ff ff       	jmp    8010541f <alltraps>
...
80105999:	6a 19                	push   $0x19
  jmp alltraps
8010599b:	e9 7f fa ff ff       	jmp    8010541f <alltraps>
...
801059a2:	6a 1a                	push   $0x1a
  jmp alltraps
801059a4:	e9 76 fa ff ff       	jmp    8010541f <alltraps>
...
801059ab:	6a 1b                	push   $0x1b
  jmp alltraps
801059ad:	e9 6d fa ff ff       	jmp    8010541f <alltraps>
...
801059b4:	6a 1c                	push   $0x1c
  jmp alltraps
801059b6:	e9 64 fa ff ff       	jmp    8010541f <alltraps>
...
801059bd:	6a 1d                	push   $0x1d
  jmp alltraps
801059bf:	e9 5b fa ff ff       	jmp    8010541f <alltraps>
...
801059c6:	6a 1e                	push   $0x1e
  jmp alltraps
801059c8:	e9 52 fa ff ff       	jmp    8010541f <alltraps>
...
801059cf:	6a 1f                	push   $0x1f
  jmp alltraps
801059d1:	e9 49 fa ff ff       	jmp    8010541f <alltraps>
...
801059d8:	6a 20                	push   $0x20
  jmp alltraps
801059da:	e9 40 fa ff ff       	jmp    8010541f <alltraps>
...
801059e1:	6a 21                	push   $0x21
  jmp alltraps
801059e3:	e9 37 fa ff ff       	jmp    8010541f <alltraps>
...
801059ea:	6a 22                	push   $0x22
  jmp alltraps
801059ec:	e9 2e fa ff ff       	jmp    8010541f <alltraps>
...
801059f3:	6a 23                	push   $0x23
  jmp alltraps
801059f5:	e9 25 fa ff ff       	jmp    8010541f <alltraps>
...
801059fc:	6a 24                	push   $0x24
  jmp alltraps
801059fe:	e9 1c fa ff ff       	jmp    8010541f <alltraps>
...
80105a05:	6a 25                	push   $0x25
  jmp alltraps
80105a07:	e9 13 fa ff ff       	jmp    8010541f <alltraps>
...
80105a0e:	6a 26                	push   $0x26
  jmp alltraps
80105a10:	e9 0a fa ff ff       	jmp    8010541f <alltraps>
...
80105a17:	6a 27                	push   $0x27
  jmp alltraps
80105a19:	e9 01 fa ff ff       	jmp    8010541f <alltraps>
...
80105a20:	6a 28                	push   $0x28
  jmp alltraps
80105a22:	e9 f8 f9 ff ff       	jmp    8010541f <alltraps>
...
80105a29:	6a 29                	push   $0x29
  jmp alltraps
80105a2b:	e9 ef f9 ff ff       	jmp    8010541f <alltraps>
...
80105a32:	6a 2a                	push   $0x2a
  jmp alltraps
80105a34:	e9 e6 f9 ff ff       	jmp    8010541f <alltraps>
...
80105a3b:	6a 2b                	push   $0x2b
  jmp alltraps
80105a3d:	e9 dd f9 ff ff       	jmp    8010541f <alltraps>
...
80105a44:	6a 2c                	push   $0x2c
  jmp alltraps
80105a46:	e9 d4 f9 ff ff       	jmp    8010541f <alltraps>
...
80105a4d:	6a 2d                	push   $0x2d
  jmp alltraps
80105a4f:	e9 cb f9 ff ff       	jmp    8010541f <alltraps>
...
80105a56:	6a 2e                	push   $0x2e
  jmp alltraps
80105a58:	e9 c2 f9 ff ff       	jmp    8010541f <alltraps>
...
80105a5f:	6a 2f                	push   $0x2f
  jmp alltraps
80105a61:	e9 b9 f9 ff ff       	jmp    8010541f <alltraps>
...
80105a68:	6a 30                	push   $0x30
  jmp alltraps
80105a6a:	e9 b0 f9 ff ff       	jmp    8010541f <alltraps>
...
80105a71:	6a 31                	push   $0x31
  jmp alltraps
80105a73:	e9 a7 f9 ff ff       	jmp    8010541f <alltraps>
...
80105a7a:	6a 32                	push   $0x32
  jmp alltraps
80105a7c:	e9 9e f9 ff ff       	jmp    8010541f <alltraps>
...
80105a83:	6a 33                	push   $0x33
  jmp alltraps
80105a85:	e9 95 f9 ff ff       	jmp    8010541f <alltraps>
...
80105a8c:	6a 34                	push   $0x34
  jmp alltraps
80105a8e:	e9 8c f9 ff ff       	jmp    8010541f <alltraps>
...
80105a95:	6a 35                	push   $0x35
  jmp alltraps
80105a97:	e9 83 f9 ff ff       	jmp    8010541f <alltraps>
...
80105a9e:	6a 36                	push   $0x36
  jmp alltraps
80105aa0:	e9 7a f9 ff ff       	jmp    8010541f <alltraps>
...
80105aa7:	6a 37                	push   $0x37
  jmp alltraps
80105aa9:	e9 71 f9 ff ff       	jmp    8010541f <alltraps>
...
80105ab0:	6a 38                	push   $0x38
  jmp alltraps
80105ab2:	e9 68 f9 ff ff       	jmp    8010541f <alltraps>
...
80105ab9:	6a 39                	push   $0x39
  jmp alltraps
80105abb:	e9 5f f9 ff ff       	jmp    8010541f <alltraps>
...
80105ac2:	6a 3a                	push   $0x3a
  jmp alltraps
80105ac4:	e9 56 f9 ff ff       	jmp    8010541f <alltraps>
...
80105acb:	6a 3b                	push   $0x3b
  jmp alltraps
80105acd:	e9 4d f9 ff ff       	jmp    8010541f <alltraps>
...
80105ad4:	6a 3c                	push   $0x3c
  jmp alltraps
80105ad6:	e9 44 f9 ff ff       	jmp    8010541f <alltraps>
...
80105add:	6a 3d                	push   $0x3d
  jmp alltraps
80105adf:	e9 3b f9 ff ff       	jmp    8010541f <alltraps>
...
80105ae6:	6a 3e                	push   $0x3e
  jmp alltraps
80105ae8:	e9 32 f9 ff ff       	jmp    8010541f <alltraps>
...
80105aef:	6a 3f                	push   $0x3f
  jmp alltraps
80105af1:	e9 29 f9 ff ff       	jmp    8010541f <alltraps>
...
80105af8:	6a 40                	push   $0x40
  jmp alltraps
80105afa:	e9 20 f9 ff ff       	jmp    8010541f <alltraps>
...
80105b01:	6a 41                	push   $0x41
  jmp alltraps
80105b03:	e9 17 f9 ff ff       	jmp    8010541f <alltraps>
...
80105b0a:	6a 42                	push   $0x42
  jmp alltraps
80105b0c:	e9 0e f9 ff ff       	jmp    8010541f <alltraps>
...
80105b13:	6a 43                	push   $0x43
  jmp alltraps
80105b15:	e9 05 f9 ff ff       	jmp    8010541f <alltraps>
...
80105b1c:	6a 44                	push   $0x44
  jmp alltraps
80105b1e:	e9 fc f8 ff ff       	jmp    8010541f <alltraps>
...
80105b25:	6a 45                	push   $0x45
  jmp alltraps
80105b27:	e9 f3 f8 ff ff       	jmp    8010541f <alltraps>
...
80105b2e:	6a 46                	push   $0x46
  jmp alltraps
80105b30:	e9 ea f8 ff ff       	jmp    8010541f <alltraps>
...
80105b37:	6a 47                	push   $0x47
  jmp alltraps
80105b39:	e9 e1 f8 ff ff       	jmp    8010541f <alltraps>
...
80105b40:	6a 48                	push   $0x48
  jmp alltraps
80105b42:	e9 d8 f8 ff ff       	jmp    8010541f <alltraps>
...
80105b49:	6a 49                	push   $0x49
  jmp alltraps
80105b4b:	e9 cf f8 ff ff       	jmp    8010541f <alltraps>
...
80105b52:	6a 4a                	push   $0x4a
  jmp alltraps
80105b54:	e9 c6 f8 ff ff       	jmp    8010541f <alltraps>
...
80105b5b:	6a 4b                	push   $0x4b
  jmp alltraps
80105b5d:	e9 bd f8 ff ff       	jmp    8010541f <alltraps>
...
80105b64:	6a 4c                	push   $0x4c
  jmp alltraps
80105b66:	e9 b4 f8 ff ff       	jmp    8010541f <alltraps>
...
80105b6d:	6a 4d                	push   $0x4d
  jmp alltraps
80105b6f:	e9 ab f8 ff ff       	jmp    8010541f <alltraps>
...
80105b76:	6a 4e                	push   $0x4e
  jmp alltraps
80105b78:	e9 a2 f8 ff ff       	jmp    8010541f <alltraps>
...
80105b7f:	6a 4f                	push   $0x4f
  jmp alltraps
80105b81:	e9 99 f8 ff ff       	jmp    8010541f <alltraps>
...
80105b88:	6a 50                	push   $0x50
  jmp alltraps
80105b8a:	e9 90 f8 ff ff       	jmp    8010541f <alltraps>
...
80105b91:	6a 51                	push   $0x51
  jmp alltraps
80105b93:	e9 87 f8 ff ff       	jmp    8010541f <alltraps>
...
80105b9a:	6a 52                	push   $0x52
  jmp alltraps
80105b9c:	e9 7e f8 ff ff       	jmp    8010541f <alltraps>
...
80105ba3:	6a 53                	push   $0x53
  jmp alltraps
80105ba5:	e9 75 f8 ff ff       	jmp    8010541f <alltraps>
...
80105bac:	6a 54                	push   $0x54
  jmp alltraps
80105bae:	e9 6c f8 ff ff       	jmp    8010541f <alltraps>
...
80105bb5:	6a 55                	push   $0x55
  jmp alltraps
80105bb7:	e9 63 f8 ff ff       	jmp    8010541f <alltraps>
...
80105bbe:	6a 56                	push   $0x56
  jmp alltraps
80105bc0:	e9 5a f8 ff ff       	jmp    8010541f <alltraps>
...
80105bc7:	6a 57                	push   $0x57
  jmp alltraps
80105bc9:	e9 51 f8 ff ff       	jmp    8010541f <alltraps>
...
80105bd0:	6a 58                	push   $0x58
  jmp alltraps
80105bd2:	e9 48 f8 ff ff       	jmp    8010541f <alltraps>
...
80105bd9:	6a 59                	push   $0x59
  jmp alltraps
80105bdb:	e9 3f f8 ff ff       	jmp    8010541f <alltraps>
...
80105be2:	6a 5a                	push   $0x5a
  jmp alltraps
80105be4:	e9 36 f8 ff ff       	jmp    8010541f <alltraps>
...
80105beb:	6a 5b                	push   $0x5b
  jmp alltraps
80105bed:	e9 2d f8 ff ff       	jmp    8010541f <alltraps>
...
80105bf4:	6a 5c                	push   $0x5c
  jmp alltraps
80105bf6:	e9 24 f8 ff ff       	jmp    8010541f <alltraps>
...
80105bfd:	6a 5d                	push   $0x5d
  jmp alltraps
80105bff:	e9 1b f8 ff ff       	jmp    8010541f <alltraps>
...
80105c06:	6a 5e                	push   $0x5e
  jmp alltraps
80105c08:	e9 12 f8 ff ff       	jmp    8010541f <alltraps>
...
80105c0f:	6a 5f                	push   $0x5f
  jmp alltraps
80105c11:	e9 09 f8 ff ff       	jmp    8010541f <alltraps>
...
80105c18:	6a 60                	push   $0x60
  jmp alltraps
80105c1a:	e9 00 f8 ff ff       	jmp    8010541f <alltraps>
...
80105c21:	6a 61                	push   $0x61
  jmp alltraps
80105c23:	e9 f7 f7 ff ff       	jmp    8010541f <alltraps>
...
80105c2a:	6a 62                	push   $0x62
  jmp alltraps
80105c2c:	e9 ee f7 ff ff       	jmp    8010541f <alltraps>
...
80105c33:	6a 63                	push   $0x63
  jmp alltraps
80105c35:	e9 e5 f7 ff ff       	jmp    8010541f <alltraps>
...
80105c3c:	6a 64                	push   $0x64
  jmp alltraps
80105c3e:	e9 dc f7 ff ff       	jmp    8010541f <alltraps>
...
80105c45:	6a 65                	push   $0x65
  jmp alltraps
80105c47:	e9 d3 f7 ff ff       	jmp    8010541f <alltraps>
...
80105c4e:	6a 66                	push   $0x66
  jmp alltraps
80105c50:	e9 ca f7 ff ff       	jmp    8010541f <alltraps>
...
80105c57:	6a 67                	push   $0x67
  jmp alltraps
80105c59:	e9 c1 f7 ff ff       	jmp    8010541f <alltraps>
...
80105c60:	6a 68                	push   $0x68
  jmp alltraps
80105c62:	e9 b8 f7 ff ff       	jmp    8010541f <alltraps>
...
80105c69:	6a 69                	push   $0x69
  jmp alltraps
80105c6b:	e9 af f7 ff ff       	jmp    8010541f <alltraps>
...
80105c72:	6a 6a                	push   $0x6a
  jmp alltraps
80105c74:	e9 a6 f7 ff ff       	jmp    8010541f <alltraps>
...
80105c7b:	6a 6b                	push   $0x6b
  jmp alltraps
80105c7d:	e9 9d f7 ff ff       	jmp    8010541f <alltraps>
...
80105c84:	6a 6c                	push   $0x6c
  jmp alltraps
80105c86:	e9 94 f7 ff ff       	jmp    8010541f <alltraps>
...
80105c8d:	6a 6d                	push   $0x6d
  jmp alltraps
80105c8f:	e9 8b f7 ff ff       	jmp    8010541f <alltraps>
...
80105c96:	6a 6e                	push   $0x6e
  jmp alltraps
80105c98:	e9 82 f7 ff ff       	jmp    8010541f <alltraps>
...
80105c9f:	6a 6f                	push   $0x6f
  jmp alltraps
80105ca1:	e9 79 f7 ff ff       	jmp    8010541f <alltraps>
...
80105ca8:	6a 70                	push   $0x70
  jmp alltraps
80105caa:	e9 70 f7 ff ff       	jmp    8010541f <alltraps>
...
80105cb1:	6a 71                	push   $0x71
  jmp alltraps
80105cb3:	e9 67 f7 ff ff       	jmp    8010541f <alltraps>
...
80105cba:	6a 72                	push   $0x72
  jmp alltraps
80105cbc:	e9 5e f7 ff ff       	jmp    8010541f <alltraps>
...
80105cc3:	6a 73                	push   $0x73
  jmp alltraps
80105cc5:	e9 55 f7 ff ff       	jmp    8010541f <alltraps>
...
80105ccc:	6a 74                	push   $0x74
  jmp alltraps
80105cce:	e9 4c f7 ff ff       	jmp    8010541f <alltraps>
...
80105cd5:	6a 75                	push   $0x75
  jmp alltraps
80105cd7:	e9 43 f7 ff ff       	jmp    8010541f <alltraps>
...
80105cde:	6a 76                	push   $0x76
  jmp alltraps
80105ce0:	e9 3a f7 ff ff       	jmp    8010541f <alltraps>
...
80105ce7:	6a 77                	push   $0x77
  jmp alltraps
80105ce9:	e9 31 f7 ff ff       	jmp    8010541f <alltraps>
...
80105cf0:	6a 78                	push   $0x78
  jmp alltraps
80105cf2:	e9 28 f7 ff ff       	jmp    8010541f <alltraps>
...
80105cf9:	6a 79                	push   $0x79
  jmp alltraps
80105cfb:	e9 1f f7 ff ff       	jmp    8010541f <alltraps>
...
80105d02:	6a 7a                	push   $0x7a
  jmp alltraps
80105d04:	e9 16 f7 ff ff       	jmp    8010541f <alltraps>
...
80105d0b:	6a 7b                	push   $0x7b
  jmp alltraps
80105d0d:	e9 0d f7 ff ff       	jmp    8010541f <alltraps>
...
80105d14:	6a 7c                	push   $0x7c
  jmp alltraps
80105d16:	e9 04 f7 ff ff       	jmp    8010541f <alltraps>
...
80105d1d:	6a 7d                	push   $0x7d
  jmp alltraps
80105d1f:	e9 fb f6 ff ff       	jmp    8010541f <alltraps>
...
80105d26:	6a 7e                	push   $0x7e
  jmp alltraps
80105d28:	e9 f2 f6 ff ff       	jmp    8010541f <alltraps>
...
80105d2f:	6a 7f                	push   $0x7f
  jmp alltraps
80105d31:	e9 e9 f6 ff ff       	jmp    8010541f <alltraps>
...
80105d38:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105d3d:	e9 dd f6 ff ff       	jmp    8010541f <alltraps>
...
80105d44:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105d49:	e9 d1 f6 ff ff       	jmp    8010541f <alltraps>
...
80105d50:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105d55:	e9 c5 f6 ff ff       	jmp    8010541f <alltraps>
...
80105d5c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105d61:	e9 b9 f6 ff ff       	jmp    8010541f <alltraps>
...
80105d68:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105d6d:	e9 ad f6 ff ff       	jmp    8010541f <alltraps>
...
80105d74:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105d79:	e9 a1 f6 ff ff       	jmp    8010541f <alltraps>
...
80105d80:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105d85:	e9 95 f6 ff ff       	jmp    8010541f <alltraps>
...
80105d8c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105d91:	e9 89 f6 ff ff       	jmp    8010541f <alltraps>
...
80105d98:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105d9d:	e9 7d f6 ff ff       	jmp    8010541f <alltraps>
...
80105da4:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105da9:	e9 71 f6 ff ff       	jmp    8010541f <alltraps>
...
80105db0:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105db5:	e9 65 f6 ff ff       	jmp    8010541f <alltraps>
...
80105dbc:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105dc1:	e9 59 f6 ff ff       	jmp    8010541f <alltraps>
...
80105dc8:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105dcd:	e9 4d f6 ff ff       	jmp    8010541f <alltraps>
...
80105dd4:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105dd9:	e9 41 f6 ff ff       	jmp    8010541f <alltraps>
...
80105de0:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105de5:	e9 35 f6 ff ff       	jmp    8010541f <alltraps>
...
80105dec:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80105df1:	e9 29 f6 ff ff       	jmp    8010541f <alltraps>
...
80105df8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105dfd:	e9 1d f6 ff ff       	jmp    8010541f <alltraps>
...
80105e04:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105e09:	e9 11 f6 ff ff       	jmp    8010541f <alltraps>
...
80105e10:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80105e15:	e9 05 f6 ff ff       	jmp    8010541f <alltraps>
...
80105e1c:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80105e21:	e9 f9 f5 ff ff       	jmp    8010541f <alltraps>
...
80105e28:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105e2d:	e9 ed f5 ff ff       	jmp    8010541f <alltraps>
...
80105e34:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80105e39:	e9 e1 f5 ff ff       	jmp    8010541f <alltraps>
...
80105e40:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80105e45:	e9 d5 f5 ff ff       	jmp    8010541f <alltraps>
...
80105e4c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80105e51:	e9 c9 f5 ff ff       	jmp    8010541f <alltraps>
...
80105e58:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105e5d:	e9 bd f5 ff ff       	jmp    8010541f <alltraps>
...
80105e64:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80105e69:	e9 b1 f5 ff ff       	jmp    8010541f <alltraps>
...
80105e70:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80105e75:	e9 a5 f5 ff ff       	jmp    8010541f <alltraps>
...
80105e7c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80105e81:	e9 99 f5 ff ff       	jmp    8010541f <alltraps>
...
80105e88:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80105e8d:	e9 8d f5 ff ff       	jmp    8010541f <alltraps>
...
80105e94:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80105e99:	e9 81 f5 ff ff       	jmp    8010541f <alltraps>
...
80105ea0:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80105ea5:	e9 75 f5 ff ff       	jmp    8010541f <alltraps>
...
80105eac:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80105eb1:	e9 69 f5 ff ff       	jmp    8010541f <alltraps>
...
80105eb8:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80105ebd:	e9 5d f5 ff ff       	jmp    8010541f <alltraps>
...
80105ec4:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105ec9:	e9 51 f5 ff ff       	jmp    8010541f <alltraps>
...
80105ed0:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80105ed5:	e9 45 f5 ff ff       	jmp    8010541f <alltraps>
...
80105edc:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80105ee1:	e9 39 f5 ff ff       	jmp    8010541f <alltraps>
...
80105ee8:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80105eed:	e9 2d f5 ff ff       	jmp    8010541f <alltraps>
...
80105ef4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80105ef9:	e9 21 f5 ff ff       	jmp    8010541f <alltraps>
...
80105f00:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80105f05:	e9 15 f5 ff ff       	jmp    8010541f <alltraps>
...
80105f0c:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80105f11:	e9 09 f5 ff ff       	jmp    8010541f <alltraps>
...
80105f18:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80105f1d:	e9 fd f4 ff ff       	jmp    8010541f <alltraps>
...
80105f24:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80105f29:	e9 f1 f4 ff ff       	jmp    8010541f <alltraps>
...
80105f30:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80105f35:	e9 e5 f4 ff ff       	jmp    8010541f <alltraps>
...
80105f3c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80105f41:	e9 d9 f4 ff ff       	jmp    8010541f <alltraps>
...
80105f48:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80105f4d:	e9 cd f4 ff ff       	jmp    8010541f <alltraps>
...
80105f54:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80105f59:	e9 c1 f4 ff ff       	jmp    8010541f <alltraps>
...
80105f60:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80105f65:	e9 b5 f4 ff ff       	jmp    8010541f <alltraps>
...
80105f6c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80105f71:	e9 a9 f4 ff ff       	jmp    8010541f <alltraps>
...
80105f78:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80105f7d:	e9 9d f4 ff ff       	jmp    8010541f <alltraps>
...
80105f84:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80105f89:	e9 91 f4 ff ff       	jmp    8010541f <alltraps>
...
80105f90:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80105f95:	e9 85 f4 ff ff       	jmp    8010541f <alltraps>
...
80105f9c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80105fa1:	e9 79 f4 ff ff       	jmp    8010541f <alltraps>
...
80105fa8:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80105fad:	e9 6d f4 ff ff       	jmp    8010541f <alltraps>
...
80105fb4:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80105fb9:	e9 61 f4 ff ff       	jmp    8010541f <alltraps>
...
80105fc0:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80105fc5:	e9 55 f4 ff ff       	jmp    8010541f <alltraps>
...
80105fcc:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80105fd1:	e9 49 f4 ff ff       	jmp    8010541f <alltraps>
...
80105fd8:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80105fdd:	e9 3d f4 ff ff       	jmp    8010541f <alltraps>
...
80105fe4:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80105fe9:	e9 31 f4 ff ff       	jmp    8010541f <alltraps>
...
80105ff0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80105ff5:	e9 25 f4 ff ff       	jmp    8010541f <alltraps>
...
80105ffc:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106001:	e9 19 f4 ff ff       	jmp    8010541f <alltraps>
...
80106008:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010600d:	e9 0d f4 ff ff       	jmp    8010541f <alltraps>
...
80106014:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106019:	e9 01 f4 ff ff       	jmp    8010541f <alltraps>
...
80106020:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106025:	e9 f5 f3 ff ff       	jmp    8010541f <alltraps>
...
8010602c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106031:	e9 e9 f3 ff ff       	jmp    8010541f <alltraps>
...
80106038:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010603d:	e9 dd f3 ff ff       	jmp    8010541f <alltraps>
...
80106044:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106049:	e9 d1 f3 ff ff       	jmp    8010541f <alltraps>
...
80106050:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106055:	e9 c5 f3 ff ff       	jmp    8010541f <alltraps>
...
8010605c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106061:	e9 b9 f3 ff ff       	jmp    8010541f <alltraps>
...
80106068:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010606d:	e9 ad f3 ff ff       	jmp    8010541f <alltraps>
...
80106074:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106079:	e9 a1 f3 ff ff       	jmp    8010541f <alltraps>
...
80106080:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106085:	e9 95 f3 ff ff       	jmp    8010541f <alltraps>
...
8010608c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106091:	e9 89 f3 ff ff       	jmp    8010541f <alltraps>
...
80106098:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010609d:	e9 7d f3 ff ff       	jmp    8010541f <alltraps>
...
801060a4:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801060a9:	e9 71 f3 ff ff       	jmp    8010541f <alltraps>
...
801060b0:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801060b5:	e9 65 f3 ff ff       	jmp    8010541f <alltraps>
...
801060bc:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801060c1:	e9 59 f3 ff ff       	jmp    8010541f <alltraps>
...
801060c8:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801060cd:	e9 4d f3 ff ff       	jmp    8010541f <alltraps>
...
801060d4:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801060d9:	e9 41 f3 ff ff       	jmp    8010541f <alltraps>
...
801060e0:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801060e5:	e9 35 f3 ff ff       	jmp    8010541f <alltraps>
...
801060ec:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801060f1:	e9 29 f3 ff ff       	jmp    8010541f <alltraps>
...
801060f8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801060fd:	e9 1d f3 ff ff       	jmp    8010541f <alltraps>
...
80106104:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106109:	e9 11 f3 ff ff       	jmp    8010541f <alltraps>
...
80106110:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106115:	e9 05 f3 ff ff       	jmp    8010541f <alltraps>
...
8010611c:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106121:	e9 f9 f2 ff ff       	jmp    8010541f <alltraps>
...
80106128:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010612d:	e9 ed f2 ff ff       	jmp    8010541f <alltraps>
...
80106134:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106139:	e9 e1 f2 ff ff       	jmp    8010541f <alltraps>
...
80106140:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106145:	e9 d5 f2 ff ff       	jmp    8010541f <alltraps>
...
8010614c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106151:	e9 c9 f2 ff ff       	jmp    8010541f <alltraps>
...
80106158:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010615d:	e9 bd f2 ff ff       	jmp    8010541f <alltraps>
...
80106164:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106169:	e9 b1 f2 ff ff       	jmp    8010541f <alltraps>
...
80106170:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106175:	e9 a5 f2 ff ff       	jmp    8010541f <alltraps>
...
8010617c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106181:	e9 99 f2 ff ff       	jmp    8010541f <alltraps>
...
80106188:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010618d:	e9 8d f2 ff ff       	jmp    8010541f <alltraps>
...
80106194:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106199:	e9 81 f2 ff ff       	jmp    8010541f <alltraps>
...
801061a0:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801061a5:	e9 75 f2 ff ff       	jmp    8010541f <alltraps>
...
801061ac:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801061b1:	e9 69 f2 ff ff       	jmp    8010541f <alltraps>
...
801061b8:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801061bd:	e9 5d f2 ff ff       	jmp    8010541f <alltraps>
...
801061c4:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801061c9:	e9 51 f2 ff ff       	jmp    8010541f <alltraps>
...
801061d0:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801061d5:	e9 45 f2 ff ff       	jmp    8010541f <alltraps>
...
801061dc:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801061e1:	e9 39 f2 ff ff       	jmp    8010541f <alltraps>
...
801061e8:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801061ed:	e9 2d f2 ff ff       	jmp    8010541f <alltraps>
...
801061f4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801061f9:	e9 21 f2 ff ff       	jmp    8010541f <alltraps>
...
80106200:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106205:	e9 15 f2 ff ff       	jmp    8010541f <alltraps>
...
8010620c:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106211:	e9 09 f2 ff ff       	jmp    8010541f <alltraps>
...
80106218:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010621d:	e9 fd f1 ff ff       	jmp    8010541f <alltraps>
...
80106224:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106229:	e9 f1 f1 ff ff       	jmp    8010541f <alltraps>
...
80106230:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106235:	e9 e5 f1 ff ff       	jmp    8010541f <alltraps>
...
8010623c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106241:	e9 d9 f1 ff ff       	jmp    8010541f <alltraps>
...
80106248:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010624d:	e9 cd f1 ff ff       	jmp    8010541f <alltraps>
...
80106254:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106259:	e9 c1 f1 ff ff       	jmp    8010541f <alltraps>
...
80106260:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106265:	e9 b5 f1 ff ff       	jmp    8010541f <alltraps>
...
8010626c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106271:	e9 a9 f1 ff ff       	jmp    8010541f <alltraps>
...
80106278:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010627d:	e9 9d f1 ff ff       	jmp    8010541f <alltraps>
...
80106284:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106289:	e9 91 f1 ff ff       	jmp    8010541f <alltraps>
...
80106290:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106295:	e9 85 f1 ff ff       	jmp    8010541f <alltraps>
...
8010629c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801062a1:	e9 79 f1 ff ff       	jmp    8010541f <alltraps>
...
801062a8:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801062ad:	e9 6d f1 ff ff       	jmp    8010541f <alltraps>
...
801062b4:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801062b9:	e9 61 f1 ff ff       	jmp    8010541f <alltraps>
...
801062c0:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801062c5:	e9 55 f1 ff ff       	jmp    8010541f <alltraps>
...
801062cc:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801062d1:	e9 49 f1 ff ff       	jmp    8010541f <alltraps>
...
801062d8:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801062dd:	e9 3d f1 ff ff       	jmp    8010541f <alltraps>
...
801062e4:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801062e9:	e9 31 f1 ff ff       	jmp    8010541f <alltraps>
...
801062f0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801062f5:	e9 25 f1 ff ff       	jmp    8010541f <alltraps>
...
801062fc:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106301:	e9 19 f1 ff ff       	jmp    8010541f <alltraps>
...
80106308:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010630d:	e9 0d f1 ff ff       	jmp    8010541f <alltraps>
...
80106314:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106319:	e9 01 f1 ff ff       	jmp    8010541f <alltraps>
...
80106320:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106325:	e9 f5 f0 ff ff       	jmp    8010541f <alltraps>
...
8010632c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106331:	e9 e9 f0 ff ff       	jmp    8010541f <alltraps>
...
80106345:	89 d6                	mov    %edx,%esi
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80106347:	c1 ea 16             	shr    $0x16,%edx
{
8010634a:	53                   	push   %ebx
  pde = &pgdir[PDX(va)];
8010634b:	8d 3c 90             	lea    (%eax,%edx,4),%edi
{
8010634e:	83 ec 1c             	sub    $0x1c,%esp
  if(*pde & PTE_P){
80106351:	8b 1f                	mov    (%edi),%ebx
80106353:	f6 c3 01             	test   $0x1,%bl
80106356:	74 28                	je     80106380 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106358:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
8010635e:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  ...
  return &pgtab[PTX(va)];
80106364:	c1 ee 0a             	shr    $0xa,%esi
}
80106367:	83 c4 1c             	add    $0x1c,%esp
  return &pgtab[PTX(va)];
8010636a:	89 f2                	mov    %esi,%edx
8010636c:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
80106372:	8d 04 13             	lea    (%ebx,%edx,1),%eax
}
80106375:	5b                   	pop    %ebx
80106376:	5e                   	pop    %esi
80106377:	5f                   	pop    %edi
...
80106380:	85 c9                	test   %ecx,%ecx
80106382:	74 34                	je     801063b8 <walkpgdir+0x78>
80106384:	e8 17 c1 ff ff       	call   801024a0 <kalloc>
80106389:	85 c0                	test   %eax,%eax
8010638b:	89 c3                	mov    %eax,%ebx
8010638d:	74 29                	je     801063b8 <walkpgdir+0x78>
    memset(pgtab, 0, PGSIZE);
8010638f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106396:	00 
80106397:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010639e:	00 
8010639f:	89 04 24             	mov    %eax,(%esp)
801063a2:	e8 39 df ff ff       	call   801042e0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
801063a7:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801063ad:	83 c8 07             	or     $0x7,%eax
801063b0:	89 07                	mov    %eax,(%edi)
801063b2:	eb b0                	jmp    80106364 <walkpgdir+0x24>
...
801063d6:	89 d3                	mov    %edx,%ebx
{
801063d8:	83 ec 1c             	sub    $0x1c,%esp
801063db:	8b 7d 08             	mov    0x8(%ebp),%edi
  a = (char*)PGROUNDDOWN((uint)va);
801063de:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
{
801063e4:	89 45 e0             	mov    %eax,-0x20(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801063e7:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
801063eb:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
801063ee:	83 4d 0c 01          	orl    $0x1,0xc(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801063f2:	81 65 e4 00 f0 ff ff 	andl   $0xfffff000,-0x1c(%ebp)
801063f9:	29 df                	sub    %ebx,%edi
801063fb:	eb 18                	jmp    80106415 <mappages+0x45>
801063fd:	8d 76 00             	lea    0x0(%esi),%esi
    if(*pte & PTE_P)
80106400:	f6 00 01             	testb  $0x1,(%eax)
80106403:	75 3d                	jne    80106442 <mappages+0x72>
    *pte = pa | perm | PTE_P;
80106405:	0b 75 0c             	or     0xc(%ebp),%esi
    if(a == last)
80106408:	3b 5d e4             	cmp    -0x1c(%ebp),%ebx
    *pte = pa | perm | PTE_P;
8010640b:	89 30                	mov    %esi,(%eax)
    if(a == last)
8010640d:	74 29                	je     80106438 <mappages+0x68>
      break;
    a += PGSIZE;
8010640f:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80106415:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106418:	b9 01 00 00 00       	mov    $0x1,%ecx
8010641d:	89 da                	mov    %ebx,%edx
8010641f:	8d 34 3b             	lea    (%ebx,%edi,1),%esi
80106422:	e8 19 ff ff ff       	call   80106340 <walkpgdir>
80106427:	85 c0                	test   %eax,%eax
80106429:	75 d5                	jne    80106400 <mappages+0x30>
    pa += PGSIZE;
  }
  return 0;
}
8010642b:	83 c4 1c             	add    $0x1c,%esp
      return -1;
...
80106441:	c3                   	ret    
      panic("remap");
80106442:	c7 04 24 70 75 10 80 	movl   $0x80107570,(%esp)
80106449:	e8 12 9f ff ff       	call   80100360 <panic>
...
80106493:	e8 58 be ff ff       	call   801022f0 <kfree>
      *pte = 0;
...
801064b1:	e8 8a fe ff ff       	call   80106340 <walkpgdir>
    if(!pte)
...
801064da:	c3                   	ret    
        panic("kfree");
801064db:	c7 04 24 c6 6e 10 80 	movl   $0x80106ec6,(%esp)
...
801064f3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801064f6:	e8 85 d1 ff ff       	call   80103680 <cpuid>
...
8010659f:	c9                   	leave  
801065a0:	c3                   	ret    
801065a1:	eb 0d                	jmp    801065b0 <switchkvm>
801065a3:	90                   	nop
801065a4:	90                   	nop
801065a5:	90                   	nop
801065a6:	90                   	nop
...
801065b0:	a1 a4 54 11 80       	mov    0x801154a4,%eax
{
...
801065d9:	8b 75 08             	mov    0x8(%ebp),%esi
  if(p == 0)
801065dc:	85 f6                	test   %esi,%esi
801065de:	0f 84 cd 00 00 00    	je     801066b1 <switchuvm+0xe1>
  if(p->kstack == 0)
801065e4:	8b 46 08             	mov    0x8(%esi),%eax
801065e7:	85 c0                	test   %eax,%eax
801065e9:	0f 84 da 00 00 00    	je     801066c9 <switchuvm+0xf9>
  if(p->pgdir == 0)
801065ef:	8b 7e 04             	mov    0x4(%esi),%edi
801065f2:	85 ff                	test   %edi,%edi
801065f4:	0f 84 c3 00 00 00    	je     801066bd <switchuvm+0xed>
  pushcli();
801065fa:	e8 31 db ff ff       	call   80104130 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801065ff:	e8 fc cf ff ff       	call   80103600 <mycpu>
80106604:	89 c3                	mov    %eax,%ebx
80106606:	e8 f5 cf ff ff       	call   80103600 <mycpu>
8010660b:	89 c7                	mov    %eax,%edi
8010660d:	e8 ee cf ff ff       	call   80103600 <mycpu>
80106612:	83 c7 08             	add    $0x8,%edi
80106615:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106618:	e8 e3 cf ff ff       	call   80103600 <mycpu>
8010661d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106620:	ba 67 00 00 00       	mov    $0x67,%edx
80106625:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
8010662c:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106633:	c6 83 9d 00 00 00 99 	movb   $0x99,0x9d(%ebx)
8010663a:	83 c1 08             	add    $0x8,%ecx
8010663d:	c1 e9 10             	shr    $0x10,%ecx
80106640:	83 c0 08             	add    $0x8,%eax
80106643:	c1 e8 18             	shr    $0x18,%eax
80106646:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
8010664c:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
80106653:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106659:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
8010665e:	e8 9d cf ff ff       	call   80103600 <mycpu>
80106663:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010666a:	e8 91 cf ff ff       	call   80103600 <mycpu>
8010666f:	b9 10 00 00 00       	mov    $0x10,%ecx
80106674:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106678:	e8 83 cf ff ff       	call   80103600 <mycpu>
8010667d:	8b 56 08             	mov    0x8(%esi),%edx
80106680:	8d 8a 00 10 00 00    	lea    0x1000(%edx),%ecx
80106686:	89 48 0c             	mov    %ecx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106689:	e8 72 cf ff ff       	call   80103600 <mycpu>
8010668e:	66 89 58 6e          	mov    %bx,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80106692:	b8 28 00 00 00       	mov    $0x28,%eax
80106697:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
8010669a:	8b 46 04             	mov    0x4(%esi),%eax
8010669d:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
801066a2:	0f 22 d8             	mov    %eax,%cr3
}
801066a5:	83 c4 1c             	add    $0x1c,%esp
801066a8:	5b                   	pop    %ebx
801066a9:	5e                   	pop    %esi
801066aa:	5f                   	pop    %edi
801066ab:	5d                   	pop    %ebp
  popcli();
801066ac:	e9 bf da ff ff       	jmp    80104170 <popcli>
    panic("switchuvm: no process");
801066b1:	c7 04 24 76 75 10 80 	movl   $0x80107576,(%esp)
801066b8:	e8 a3 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
801066bd:	c7 04 24 a1 75 10 80 	movl   $0x801075a1,(%esp)
801066c4:	e8 97 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
801066c9:	c7 04 24 8c 75 10 80 	movl   $0x8010758c,(%esp)
801066d0:	e8 8b 9c ff ff       	call   80100360 <panic>
801066d5:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
801066ef:	8b 7d 0c             	mov    0xc(%ebp),%edi
  if(sz >= PGSIZE)
801066f2:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
{
801066f8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
801066fb:	77 54                	ja     80106751 <inituvm+0x71>
  mem = kalloc();
801066fd:	e8 9e bd ff ff       	call   801024a0 <kalloc>
  memset(mem, 0, PGSIZE);
80106702:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106709:	00 
8010670a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106711:	00 
  mem = kalloc();
80106712:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106714:	89 04 24             	mov    %eax,(%esp)
80106717:	e8 c4 db ff ff       	call   801042e0 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
8010671c:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106722:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106727:	89 04 24             	mov    %eax,(%esp)
8010672a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010672d:	31 d2                	xor    %edx,%edx
8010672f:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80106736:	00 
80106737:	e8 94 fc ff ff       	call   801063d0 <mappages>
  memmove(mem, init, sz);
8010673c:	89 75 10             	mov    %esi,0x10(%ebp)
8010673f:	89 7d 0c             	mov    %edi,0xc(%ebp)
80106742:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
...
8010674b:	5d                   	pop    %ebp
  memmove(mem, init, sz);
8010674c:	e9 2f dc ff ff       	jmp    80104380 <memmove>
    panic("inituvm: more than a page");
80106751:	c7 04 24 b5 75 10 80 	movl   $0x801075b5,(%esp)
...
801067a3:	e8 98 fb ff ff       	call   80106340 <walkpgdir>
...
80106802:	c7 04 24 cf 75 10 80 	movl   $0x801075cf,(%esp)
80106809:	e8 52 9b ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
8010680e:	c7 04 24 70 76 10 80 	movl   $0x80107670,(%esp)
...
8010682e:	0f 88 7e 00 00 00    	js     801068b2 <allocuvm+0x92>
  if(newsz < oldsz)
80106834:	3b 7d 0c             	cmp    0xc(%ebp),%edi
    return oldsz;
80106837:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
8010683a:	72 78                	jb     801068b4 <allocuvm+0x94>
  a = PGROUNDUP(oldsz);
8010683c:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106842:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
80106848:	39 df                	cmp    %ebx,%edi
8010684a:	77 4a                	ja     80106896 <allocuvm+0x76>
8010684c:	eb 72                	jmp    801068c0 <allocuvm+0xa0>
8010684e:	66 90                	xchg   %ax,%ax
    memset(mem, 0, PGSIZE);
80106850:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106857:	00 
80106858:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010685f:	00 
80106860:	89 04 24             	mov    %eax,(%esp)
80106863:	e8 78 da ff ff       	call   801042e0 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106868:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
8010686e:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106873:	89 04 24             	mov    %eax,(%esp)
80106876:	8b 45 08             	mov    0x8(%ebp),%eax
80106879:	89 da                	mov    %ebx,%edx
8010687b:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80106882:	00 
80106883:	e8 48 fb ff ff       	call   801063d0 <mappages>
80106888:	85 c0                	test   %eax,%eax
8010688a:	78 44                	js     801068d0 <allocuvm+0xb0>
  for(; a < newsz; a += PGSIZE){
8010688c:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106892:	39 df                	cmp    %ebx,%edi
80106894:	76 2a                	jbe    801068c0 <allocuvm+0xa0>
    mem = kalloc();
80106896:	e8 05 bc ff ff       	call   801024a0 <kalloc>
    if(mem == 0){
8010689b:	85 c0                	test   %eax,%eax
    mem = kalloc();
8010689d:	89 c6                	mov    %eax,%esi
    if(mem == 0){
8010689f:	75 af                	jne    80106850 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
801068a1:	c7 04 24 ed 75 10 80 	movl   $0x801075ed,(%esp)
801068a8:	e8 a3 9d ff ff       	call   80100650 <cprintf>
  if(newsz >= oldsz)
801068ad:	3b 7d 0c             	cmp    0xc(%ebp),%edi
801068b0:	77 48                	ja     801068fa <allocuvm+0xda>
      return 0;
801068b2:	31 c0                	xor    %eax,%eax
}
801068b4:	83 c4 1c             	add    $0x1c,%esp
801068b7:	5b                   	pop    %ebx
801068b8:	5e                   	pop    %esi
801068b9:	5f                   	pop    %edi
801068ba:	5d                   	pop    %ebp
...
801068c0:	83 c4 1c             	add    $0x1c,%esp
...
80106920:	5d                   	pop    %ebp
80106921:	e9 2a fb ff ff       	jmp    80106450 <deallocuvm.part.0>
...
8010694a:	e8 01 fb ff ff       	call   80106450 <deallocuvm.part.0>
...
8010697d:	e8 6e b9 ff ff       	call   801022f0 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
...
80106992:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106993:	e9 58 b9 ff ff       	jmp    801022f0 <kfree>
    panic("freevm: no pgdir");
80106998:	c7 04 24 21 76 10 80 	movl   $0x80107621,(%esp)
...
801069b8:	e8 e3 ba ff ff       	call   801024a0 <kalloc>
801069bd:	85 c0                	test   %eax,%eax
801069bf:	89 c6                	mov    %eax,%esi
801069c1:	74 6d                	je     80106a30 <setupkvm+0x80>
...
801069e6:	8b 4b 08             	mov    0x8(%ebx),%ecx
801069e9:	89 54 24 04          	mov    %edx,0x4(%esp)
801069ed:	8b 13                	mov    (%ebx),%edx
801069ef:	89 04 24             	mov    %eax,(%esp)
801069f2:	29 c1                	sub    %eax,%ecx
801069f4:	89 f0                	mov    %esi,%eax
801069f6:	e8 d5 f9 ff ff       	call   801063d0 <mappages>
801069fb:	85 c0                	test   %eax,%eax
801069fd:	78 19                	js     80106a18 <setupkvm+0x68>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801069ff:	83 c3 10             	add    $0x10,%ebx
80106a02:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80106a08:	72 d6                	jb     801069e0 <setupkvm+0x30>
80106a0a:	89 f0                	mov    %esi,%eax
}
...
80106a14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      freevm(pgdir);
80106a18:	89 34 24             	mov    %esi,(%esp)
80106a1b:	e8 10 ff ff ff       	call   80106930 <freevm>
}
...
80106a32:	eb d8                	jmp    80106a0c <setupkvm+0x5c>
...
80106a6e:	e8 cd f8 ff ff       	call   80106340 <walkpgdir>
  if(pte == 0)
...
80106a7b:	c3                   	ret    
    panic("clearpteu");
80106a7c:	c7 04 24 32 76 10 80 	movl   $0x80107632,(%esp)
...
80106aa3:	0f 84 b9 00 00 00    	je     80106b62 <copyuvm+0xd2>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106aa9:	8b 45 0c             	mov    0xc(%ebp),%eax
80106aac:	85 c0                	test   %eax,%eax
80106aae:	0f 84 94 00 00 00    	je     80106b48 <copyuvm+0xb8>
80106ab4:	31 ff                	xor    %edi,%edi
80106ab6:	eb 48                	jmp    80106b00 <copyuvm+0x70>
...
80106ab8:	81 c6 00 00 00 80    	add    $0x80000000,%esi
80106abe:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106ac5:	00 
80106ac6:	89 74 24 04          	mov    %esi,0x4(%esp)
80106aca:	89 04 24             	mov    %eax,(%esp)
80106acd:	e8 ae d8 ff ff       	call   80104380 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106ad2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106ad5:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106ada:	89 fa                	mov    %edi,%edx
80106adc:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ae0:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106ae6:	89 04 24             	mov    %eax,(%esp)
80106ae9:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106aec:	e8 df f8 ff ff       	call   801063d0 <mappages>
80106af1:	85 c0                	test   %eax,%eax
80106af3:	78 63                	js     80106b58 <copyuvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
80106af5:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106afb:	39 7d 0c             	cmp    %edi,0xc(%ebp)
80106afe:	76 48                	jbe    80106b48 <copyuvm+0xb8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106b00:	8b 45 08             	mov    0x8(%ebp),%eax
80106b03:	31 c9                	xor    %ecx,%ecx
80106b05:	89 fa                	mov    %edi,%edx
80106b07:	e8 34 f8 ff ff       	call   80106340 <walkpgdir>
80106b0c:	85 c0                	test   %eax,%eax
80106b0e:	74 62                	je     80106b72 <copyuvm+0xe2>
    if(!(*pte & PTE_P))
80106b10:	8b 00                	mov    (%eax),%eax
80106b12:	a8 01                	test   $0x1,%al
80106b14:	74 50                	je     80106b66 <copyuvm+0xd6>
    pa = PTE_ADDR(*pte);
80106b16:	89 c6                	mov    %eax,%esi
    flags = PTE_FLAGS(*pte);
80106b18:	25 ff 0f 00 00       	and    $0xfff,%eax
80106b1d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106b20:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    if((mem = kalloc()) == 0)
80106b26:	e8 75 b9 ff ff       	call   801024a0 <kalloc>
80106b2b:	85 c0                	test   %eax,%eax
80106b2d:	89 c3                	mov    %eax,%ebx
80106b2f:	75 87                	jne    80106ab8 <copyuvm+0x28>
    }
  }
  return d;
...
80106b37:	e8 f4 fd ff ff       	call   80106930 <freevm>
  return 0;
...
80106b4b:	83 c4 2c             	add    $0x2c,%esp
80106b4e:	5b                   	pop    %ebx
80106b4f:	5e                   	pop    %esi
80106b50:	5f                   	pop    %edi
80106b51:	5d                   	pop    %ebp
...
80106b54:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      kfree(mem);
80106b58:	89 1c 24             	mov    %ebx,(%esp)
80106b5b:	e8 90 b7 ff ff       	call   801022f0 <kfree>
      goto bad;
80106b60:	eb cf                	jmp    80106b31 <copyuvm+0xa1>
    return 0;
80106b62:	31 c0                	xor    %eax,%eax
80106b64:	eb d8                	jmp    80106b3e <copyuvm+0xae>
      panic("copyuvm: page not present");
80106b66:	c7 04 24 56 76 10 80 	movl   $0x80107656,(%esp)
80106b6d:	e8 ee 97 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106b72:	c7 04 24 3c 76 10 80 	movl   $0x8010763c,(%esp)
...
80106b8e:	e8 ad f7 ff ff       	call   80106340 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106bfc:	e8 7f d7 ff ff       	call   80104380 <memmove>
    len -= n;
    buf += n;
